class Api::V1::KTagFollowsController < ApplicationController
  ...
  def create
    @api_v1_follow_k_tag = KTagFollow.new(account_id: current_user&.id, params.permit( :tag_id))
  ...
  private
    ...
    def set_api_v1_follow_k_tag
      @api_v1_follow_k_tag = KTagFollow.find(params[:id])
    end
