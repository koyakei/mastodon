...
import type { NotificationGroupKTagAddRelationRequestDenied } from 'mastodon/models/notification_group';
...
export const NotificationKTagAddRelationRequestDenied: React.FC<{
  notification: NotificationGroupKTagAddRelationRequestDenied;
  unread: boolean;
}> = ({ notification, unread }) => {
