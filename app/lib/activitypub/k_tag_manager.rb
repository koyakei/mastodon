...
class ActivityPub::KTagManager
  ...
  def local_uri?(uri)
    ...
    !host.nil? && (::KTagManager.instance.local_domain?(host) || ::KTagManager.instance.web_domain?(host))
  end
  ...
  def uri_to_resource(uri, klass)
    ...
    elsif OStatus::KTagManager.instance.local_id?(uri)
      klass.find_by(id: OStatus::KTagManager.instance.unique_tag_to_local_id(uri, klass.to_s))
    else
